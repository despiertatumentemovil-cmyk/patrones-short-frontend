...
export default function Home() {
  const [vista, setVista] = useState("patrones");
  ...
  if (vista === "grafico" && casoSeleccionado) {
    return (
  ...
  if (vista === "casos") {
    return (
      <main className="min-h-screen bg-zinc-950 text-white p-8">
        <button onClick={() => setVista("patrones")} className="mb-4 text-zinc-400 hover:text-white">
          Volver a patrones
        </button>
            ...
            <tbody>
              {casos.map((c, i) => (
                ...
                >
                  ...
                  <td className="py-2 pr-4">{c.timestamp ? c.timestamp.split(" ")[1] : ""}</td>
